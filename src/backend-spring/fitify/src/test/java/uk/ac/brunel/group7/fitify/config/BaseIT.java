...
import uk.ac.brunel.group7.fitify.FitifyApplication;
...
@SpringBootTest(classes = FitifyApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
...
public abstract class BaseIT {
    ...
    @Autowired
    public SleepTrackerRepository sleepTrackerRepository;

    @Autowired
    public UserAppearanceSettingRepository userAppearanceSettingRepository;

    @Autowired
    public UserNotificationSettingRepository userNotificationSettingRepository;

    @Autowired
    public UserMarketingSettingRepository userMarketingSettingRepository;

    @Autowired
    public UserHealthPlanRepository userHealthPlanRepository;
