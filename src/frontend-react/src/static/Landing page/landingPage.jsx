...
class LandingPage extends React.Component {
  ...
  render() {
    ...
    return (
        ...
        <div data-layer="db4238ef-c62c-47fd-9ff0-8550d1e9e531" className="home">Home</div>
        <div data-layer="86a65718-96bf-44f4-af17-77341978d82b" className="signIn">Sign in</div>
        <div data-layer="f630dc31-7e1f-4466-8cf4-8b7fdfdc67df" className="review">Review</div>
        <div data-layer="b8889e6b-4f00-4793-8372-cc9c30a98fde" className="help">Help</div>
</div>
