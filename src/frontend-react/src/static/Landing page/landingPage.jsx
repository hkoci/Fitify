...
class LandingPage extends React.Component {
  ...
  render() {
    ...
    return (
          <div data-layer="d23c8daa-0d9f-4576-aef7-3c1b4d55ef79" className="landingPage">        <div data-layer="498884de-4f2e-4a53-9958-39c5f9207f12" className="background"></div>
